...
def render_customer_info():
    ...
    st.header("A. 客戶資訊")
    odm = st.selectbox("ODM客戶 (RD)", ["(01)仁寶", "(02)廣達", "(03)緯創", "(04)華勤", "(05)光寶", "(06)技嘉", "(07)智邦", "(08)技鋼", "(09)和碩", "(10)Solidigm", "(00)其他"], key="odm")
    if odm == "(08)其他":
        odm = st.text_input("請輸入ODM客戶", key="odm_other")
    brand = st.selectbox("品牌客戶 (RD)", ["(01)惠普", "(02)聯想", "(03)高通", "(04)華碩", "(05)宏碁", "(06)微星", "(07)智邦", "(08)技鋼", "(09)和碩", "(10)Solidigm", "(00)其他"], key="brand")
    if brand == "(08)其他":
